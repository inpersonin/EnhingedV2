      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto grid gap-12 lg:grid-cols-[1fr_1.5fr] items-center">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            The frontend is a static export deployed on GitHub Pages. The backend runs on a Hugging Face Space with a custom FastAPI wrapper around the PyTorch model.
          </p>
          <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            View HF Backend <ArrowUpRight className="size-3.5" />
          </a>
        </motion.div>
