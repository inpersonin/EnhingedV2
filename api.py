"""FastAPI service for Enhinged V2 inference."""
...
class GenerateRequest(BaseModel):
    ...
    # V2: default reduced from 200 to 110 for faster casual chat; still
    # configurable up to 512 for anyone who needs longer outputs.
